...
public class ComparatorServicesByStatus implements Comparator<Service>
{
    /**
    ...
    public ComparatorServicesByStatus(boolean isUp){
        this.isUp = isUp;
    }
    ...
    {
        int res = o1.getStatus().toString().compareTo(o2.getStatus().toString());
